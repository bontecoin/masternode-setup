...
4. Send 100000 BONTE to this address and wait for at least 1 confirmation
...
```
bash <( curl -sL https://raw.githubusercontent.com/bontecoin/masternode-setup/main/masternodeinstall.sh)
```
...
```<alias> <ip>:3094 <private_key> <tx_id> <index>```
3. It should look something like this:
``` MN1 127.0.0.2:3094 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX X```
...
3. Enter ```bontecoin-cli getmasternodestatus```
4. This will tell you the status of your masternode, any questions, Join discord for help: https://discord.gg/rtHT3TsZNd
